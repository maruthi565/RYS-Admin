...
@Component({
    selector: 'user-merchandise',
    templateUrl: './user-merchandise.component.html',
    styleUrls: ['./user-merchandise.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class UserMerchandiseDialog {
    showExtraToFields: boolean;
    composeForm: FormGroup;
    fromPage: any;

    @ViewChild('userMerchdmatCarouselSlide', { static: true }) imgEl: ElementRef;
    /**
     * Constructor
     *
     * @param {MatDialogRef<UserMerchandiseDialog>} matDialogRef
     * @param _data
     */
    constructor(
        public matDialogRef: MatDialogRef<UserMerchandiseDialog>,
