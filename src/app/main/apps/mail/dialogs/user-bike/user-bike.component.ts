...
@Component({
    ...
    styleUrls: ['./user-bike.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class UserBikeDialog {
    showExtraToFields: boolean;
    composeForm: FormGroup;
    fromPage: any;
    refresh: Subject<any> = new Subject();

    @ViewChild('userBikematCarouselSlide', { static: true }) imgEl: ElementRef;

    /**
     * Constructor
     *
     * @param {MatDialogRef<UserBikeDialog>} matDialogRef
     * @param _data
     */
    constructor(
        public matDialogRef: MatDialogRef<UserBikeDialog>,
    ...
    //         "Status" : 1
    //     }
    //     this._ecommerceBikeUserPostedService.AcceptUserBike(data,bikeJson).then((data) => {
    ...
    //         "Status" : 0
    //     }
    //     this._ecommerceBikeUserPostedService.RejectUserBike(data,bikerejectJson).then((data) => {
