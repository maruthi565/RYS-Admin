...
@Component({
  selector: "dialog-content-event-example-dialog",
  templateUrl: "dialog-content-event-example-dialog.html"
})
export class EventDialogContentExampleDialog {
          ...
          if (results[0]) {
            ...
            for (var i = 0; i < results.length; i++) {
              if (results[i].types[0] === "locality") {
                ...
                localStorage.setItem("EventCity", this.city);
