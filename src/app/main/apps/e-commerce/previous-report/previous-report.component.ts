...
import { EcommercePreviousReportsService } from './previous-report.service';
...
@Component({
    selector: 'e-commerce-previous-report',
    templateUrl: './previous-report.component.html',
    styleUrls: ['./previous-report.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class EcommercePreviousReportComponent implements OnInit {
    //dataSource: FilesDataSource | null;
    dataSource : MatTableDataSource<any>;
    displayedColumns = ['select', 'id', 'username', 'date', 'reported', 'ride', 'type', 'action'];
    ...
    constructor(
        ...
        private dialog: MatDialog,private _previousreportsService : EcommercePreviousReportsService
    ) {
     ...
     */
    ngOnInit(): void {
        this._previousreportsService.getPreviousReports()
        .then(data => {
            this.previousData = data.UserReports
