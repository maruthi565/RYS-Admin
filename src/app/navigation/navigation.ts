...
export const navigation: FuseNavigation[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/biker-stories"
      },
      {
        id: "after-market",
        title: "After Market",
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/after-market"
      },
      {
        id: "user-posted",
        title: "User Posted",
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/user-posted"
      },
      {
        id: "ads-posted",
        title: "Ads Posted",
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/ads-posted"
      },
      {
        id: "feedback",
        title: "Feedback",
      ...
      },
      {
        ...
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/business-query"
      },
      {
        id: "notifcation",
        title: "Notifications",
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/notification"
      },
      {
        id: "sos",
        title: "SOS",
      ...
      //     type: 'item',
      //     icon: 'dashboard',
      //     url: '/apps/e-commerce/admin-users'
      // },
      {
        id: "sos-contacts",
        title: "SOS Contacts",
        type: "item",
        icon: "dashboard",
        url: "/apps/e-commerce/sos-contacts"
      }
      // {
      ...
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/merchandise-products'
      // },
      ...
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/redeemed-coupons'
      // },
      // {
      //     id: 'my-coupons',
      //     title: 'My Coupons',
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/my-coupons'
      // },
      // {
      //     id: 'add-coupon',
      //     title: 'Add Coupons',
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/add-coupon'
      // },
      ...
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/edit-coupon'
      // },
      // {
      //     id: 'merchandise',
      //     title: 'Merchandise',
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/merchandise'
      // },
      // {
      //     id: 'add-merchandise',
      ...
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/add-merchandise'
      // },
      // {
      //     id: 'edit-merchandise',
      ...
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/edit-merchandise'
      // },
      // {
      //     id: 'purchased-merchandise',
      //     title: 'Purchased Merchandise',
      //     type: 'item',
      //     icon: 'today',
      //     url: '/apps/e-commerce/purchased-merchandise'
      // },
      // {
      //     id: 'stores',
      //     title: 'Stores',
